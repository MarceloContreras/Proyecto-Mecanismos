...
function [xA, xB, xC, xD, xE, xF,x_g1,x_g2,x_g3,x_g4,x_g5,x_g6,x_g7,x_g8,theta3,theta4,theta5,theta6,theta7,theta8] = find_pos_mecanismo1(x)
Lab = x(1);
Lbc = x(2);
Lad = x(3);
Lae = x(4);
...
x_g8 = FindPos(xF, Ldf/2, e8);
x_g7 = FindPos(xF, Lef/2, e7);
x_g6 = FindPos(xE, Lce/2, e6);
x_g5 = FindPos(xD, Lcd/2, e5);
x_g4 = FindPos(xE, Lae/2, e4);
x_g3 = FindPos(xD, Lad/2, e3);
x_g2 = FindPos(xC, Lbc/2, e2);
x_g1 = FindPos(xB, Lab/2, e1);
